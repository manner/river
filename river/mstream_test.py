...
df_categ = pd.read_csv("./test_data_small/unswcateg_10k.txt", header=None)
df_numeric = pd.read_csv("./test_data_small/unswnumeric_10k.txt", header=None)
df_time = pd.read_csv("./test_data_small/unswtime_10k.txt", header=None)
X = pd.concat([df_numeric, df_categ, df_time], axis=1)
X.columns = headers
Y = pd.read_csv("./test_data_small/unsw_label_10k.txt")
